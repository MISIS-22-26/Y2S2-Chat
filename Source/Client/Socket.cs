...
public class Socket(int port, System.Net.IPAddress? address, System.Net.Sockets.ProtocolType protocol) : Core.Net.Socket.Socket(port, address, buffer_size, protocol)
{
